...
public class MonitorJobService {
    ...
    private static Map<String, String> envNameMap = new HashMap<String, String>() {{
        put("default", "本地环境");
        put("dev", "开发环境");
        put("test", "测试环境");
        put("production", "生产环境");
    ...
    public static void main(String[] args) throws InterruptedException {
        MonitorJobService job = new MonitorJobService();
        while (true) {
            job.checkAll();
            Thread.sleep(60000);
        }
    ...
    private String checkNoProviders() {
        ...
        List<Application> applicationList = manageService.getApplicationList();
